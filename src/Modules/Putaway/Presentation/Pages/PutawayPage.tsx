...
import { Loader2, MapPin, RefreshCw, Send, Warehouse } from 'lucide-react';
      ...
      <section className="space-y-4">
        ...
        <div className="grid gap-3 md:grid-cols-2 xl:grid-cols-3">
          {query.isLoading ? (
            ...
            <div className="text-muted-foreground text-sm">No putaway tasks match the current filters.</div>
          ) : (

...
import type { InboundPlanDto, PagedInboundPlanDto } from '@modules/InboundPlan/Infrastructure/Dtos/InboundPlanDtos';
...
describe('InboundPlanMapper', () => {
  it('maps PascalCase inbound plan DTOs into camelCase domain objects', () => {
    expect(InboundPlanMapper.toInboundPlan(inboundPlanDto)).toMatchObject({
      id: 'inbound-plan-1',
      sourceSystem: 'ERP',
      sourceDocumentType: 'ASN',
      sourceDocumentNumber: 'ASN-10001',
  ...
  it('maps paged envelopes and tolerates null list payloads', () => {
    ...
    expect(InboundPlanMapper.toPaged(page)).toEqual({
    ...
    expect(InboundPlanMapper.toPaged(null as unknown as PagedInboundPlanDto)).toEqual({
      items: [],
      page: 1,
      pageSize: 0,
      totalItems: 0,
  ...
  it('builds PascalCase create, update and gate-in payloads', () => {
    expect(
      InboundPlanMapper.toCreateRequest({
        sourceSystem: 'ERP',
        sourceDocumentType: 'ASN',
        sourceDocumentNumber: 'ASN-10001',
        supplierId: 'supplier-1',
    ...
    expect(
      InboundPlanMapper.toUpdateRequest({
        sourceSystem: 'ERP',
        sourceDocumentType: 'ASN',
        sourceDocumentNumber: 'ASN-10001',
        supplierId: 'supplier-1',
    ...
    expect(
      InboundPlanMapper.toGateInRequest({

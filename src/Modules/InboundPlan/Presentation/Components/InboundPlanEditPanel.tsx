...
interface InboundPlanEditPanelProps {
  plan: InboundPlan;
  isPending: boolean;
...
// components InboundPlanCreatePage renders (InboundPlanTextFields/ScopeFields/LinesEditor +
...
export function InboundPlanEditPanel({ plan, isPending, errorMessage, onSubmit, onCancel }: InboundPlanEditPanelProps) {

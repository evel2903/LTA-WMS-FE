...
import { InboundPlanLinesEditor } from '@modules/InboundPlan/Presentation/Components/InboundPlanLinesEditor';
import type { InboundPlanLineDraft } from '@modules/InboundPlan/Presentation/Components/InboundPlanLinesEditor';
import { InboundPlanScopeFields } from '@modules/InboundPlan/Presentation/Components/InboundPlanScopeFields';
import { InboundPlanTextFields } from '@modules/InboundPlan/Presentation/Components/InboundPlanTextFields';
import { useInboundPlanFormLookups } from '@modules/InboundPlan/Presentation/Components/UseInboundPlanFormLookups';
import type { InboundLineImportPreview } from '@modules/InboundPlan/Domain/Types/InboundPlan';
...
export function InboundPlanCreatePage() {
  ...
  function commitExcelImport() {
    ...
    mutations.commitLineImport.mutate(
      ...
      { onSuccess: (plan) => void navigate(ROUTES.INBOUND_PLAN.DETAIL(plan.id)) },
    );
  }
  ...
  function submitCreate(event: FormEvent<HTMLFormElement>) {
    ...
    mutations.createInboundPlan.mutate(
      ...
      {
        onSuccess: (plan) => {
          void navigate(ROUTES.INBOUND_PLAN.DETAIL(plan.id));
        },
      },
    );
  }
      ...
      <form className="space-y-4" onSubmit={submitCreate}>
        ...
        <div className="flex flex-col-reverse gap-2 border-t pt-3 sm:flex-row sm:justify-end">
          <Button asChild variant="secondary">
            <Link to={ROUTES.INBOUND_PLAN.ROOT}>Hủy</Link>
          </Button>
          <Button

...
const migratedRootPages = [
  ...
  ['Modules/Inbound/Presentation/Pages/InboundPage.tsx', 'ListPageShell'],
...
const representativeDetailPages = [
  ...
  'Modules/Inbound/Presentation/Pages/InboundDetailPage.tsx',
...
describe('V1-UX list/detail guardrails', () => {
  it('keeps representative list, create, detail and action route constants stable', () => {
    expect({
      ...
      inboundAction: ROUTES.INBOUND.ACTION('inbound-1', 'receiving'),
      ...
      inboundAction: '/inbound/inbound-1/receiving',
